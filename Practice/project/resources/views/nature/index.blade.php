...
-->
    ...
    <body>
        <div id="main-wrapper">
            ...
            <div class="menu visible-md visible-lg">
             ...
             <div class="image-section">
                <div class="image-container">
                    <img src="{{asset('assets/nature/images/nature1.jpg')}}" id="home-img" class="main-img inactive" alt="Home">
                    <img src="{{asset('assets/nature/images/nature2.jpg')}}" id="about-img" class="inactive" alt="About">
                    <img src="{{asset('assets/nature/images/nature3.jpg')}}" id="services-img"  class="inactive" alt="Services">
                    <img src="{{asset('assets/nature/images/nature4.jpg')}}" id="testimonial-img" class="inactive" alt="Testimonial">
                    <img src="{{asset('assets/nature/images/nature5.jpg')}}" id="contact-img" class="inactive" alt="Contact">
                </div>
            </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <form action="{{url('/contact-post')}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="email" id="contact_email" class="form-control" placeholder="Email Address" />
                                                </div>
                                                <div class="form-group">
                                                    <!--<label for="contact_message">Message:</label>-->
                                                    <textarea id="contact_message" name="message" class="form-control" rows="7" placeholder="Write a message"></textarea>
                                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer">
                    <p class="footer-text">
                    	<span>Copyright &copy; webcoir</span>
                	</p>
                </div><!-- /.footer --> 
            </div>
        ...
        <script src="{{asset('assets/nature/js/jquery.min.js')}}"></script>
        <script src="{{asset('assets/nature/js/jquery.backstretch.min.js')}}"></script>
        <script src="{{asset('assets/Nature/js/templatemo_script.js')}}"></script>
