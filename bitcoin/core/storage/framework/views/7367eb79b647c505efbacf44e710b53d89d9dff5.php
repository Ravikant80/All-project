            ...
            <div class="portlet-body" id="layout-body">
               ...
               <form action="" method="post" role="form" onsubmit="">
                  ...
                  <div class="form-group m-b-10">
                     ...
                     <input id="phone" type="tel" name="phone" id="phoneNumberText" class="form-control input-lg" value="<?php echo e($phone); ?>" autocomplete="off" spellcheck="false" dir="auto"><span class="form-control-feedback form-control-feedback-countryflag control-feedback-lg"><img src="https://api.monetbil.com/assets/img/drp/CM.png" alt="CM"></span>
                  </div>
                 ...
                 <div class="form-group m-b-10">
                     ...
                     <input type="tel" name="amount" id="amount" class="form-control input-lg" value="" autocomplete="off" spellcheck="false" dir="auto"><span class="form-control-feedback form-control-feedback-countryflag control-feedback-lg">
                         <img src="<?php echo e(url('assets/images/cfa.png')); ?>" alt="CM"></span>
                  </div>
                  ...
                  <div class="row m-0">
                     <div class="col-xs-6 p-0 p-r-5"><a href="<?php echo e(url('payment/dashboard')); ?>"  class="btn btn-inverse btn-block btn-custom m-b-5">Back</a></div>
                     <div class="col-xs-6 p-0 p-l-5"><button onclick="sendRequest('<?php echo e(url('payment/deposit')); ?>','depositForm',this)" type="button" class="btn btn-info btn-block m-b-5">Next</button></div>
                  </div>
                <!--   <div class="mno-illustrations">
                     <div class="mno-content">
                        <div><img title="Mobile Telephone Network Cameroon Ltd" src="<?php echo e(url('assets/images/mtn_money.png')); ?>" alt=""></div>
                     </div>
                  </div> -->
               </form>
            </div>
