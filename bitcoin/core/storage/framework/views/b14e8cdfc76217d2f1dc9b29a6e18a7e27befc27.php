            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="product<?php echo e($product->id); ?>">
                                <td><?php echo e($product->id); ?></td>
                                <td><?php echo e($product->title); ?></td>
                                <td style="font-size: 22px;"><?php echo $product->code; ?></td>
                                <td>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        var url = '<?php echo e(url("/admin/manage-service")); ?>';
