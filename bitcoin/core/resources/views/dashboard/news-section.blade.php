                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach ($newsdata as $key=>$news)
                            <tr id="news{{$news->news_id}}">
                                ...
                                @if($news->image != null)
                                <td><img src="{{url('assets/images/news/'.$news->image)}}" height="50px" width="50px"></td>
                                @else
                                <td>No Image For this News</td>
                                @endif
                                @if($news->video != null)
                                <td><video width="50px" height="50px" controls>
                                     <source src="{{url('assets/images/news/'.$news->video)}}" type="video/mp4">
                                ...
                                @endif
                                @if($news->otherlinks != null)
                                <td><a href="{{$news->otherlinks}}">Link</td>
                                 @else
                                <td>No Other Links For this News</td>
                                @endif
                                <td>
                                    
                                    <!-- <a href="{{url('admin/news-view/'.$news->news_id)}}" class="btn btn-primary btn-detail open_modal bold uppercase"><i class="fa fa-eye-slash"></i> View</a> -->
                                    <button id="newsView" class="btn btn-primary btn-detail  bold uppercase" value="{{$news->news_id}}"><i class="fa fa-eye-slash"></i> View</button>
                                    <button class="btn btn-primary btn-detail open_modal bold uppercase" value="{{$news->news_id}}"><i class="fa fa-edit"></i> EDIT</button>
                                     <a href="{{url('admin/delete-news/'.$news->news_id)}}" class="btn btn-primary btn-detail open_modal bold uppercase" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i> Delete</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group error">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <img src="{{url('assets/images/news/')}}" height="200px" width="390px" id="viewImage">
                                </div>
                            </div>
                        </div>
                        <div class="form-group error">
...
//                }
    ...
    var url = '{{ url('/admin/news-section') }}';
...
//                    }
    ...
    <script>
        var url1 = '{{ url('/admin/news-section') }}';
        $(document).on('click','#newsView',function(){
            ...
            $.get(url1 + '/' + newsView_id, function (data) {
               ...
               // alert(data.image);
                ...
                $('#viewImage').attr('src','{{url("assets/images/news/")}}/'+data.image);
