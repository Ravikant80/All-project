                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <h3 class="text-center " id="changebalance">{{ round(Auth::user()->balance,8) }} CFA</h3>
                              ...
                              <table class="table table-de mb-0">                    
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td> {{ round(Auth::user()->balance,8) }} CFA</td>                        
                                  </tr> 
                                  <tr>
<!--                                          <td align="center" colspan="2" ><a href="javascript:;" style="color:#000000;" data-toggle="modal" data-target="#CurConversionModal"><i class="fa fa-exchange"></i> Convert</a></td>-->
                ...
                <div class="card">
                        <div class="card-content collapse show" style="padding: 7px;text-align: center;">
                                ...
                                <td class="text-center btn btn-default" style="color: #000;"><i class="fa fa-money"></i> Bonus Amount : {{round($amountsum,8)}} CFA </td>
