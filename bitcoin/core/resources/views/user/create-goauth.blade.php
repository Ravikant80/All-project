  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h6 style="float:left;" class="modal-title">Verify Your OTP</h6>
        <div class="pull-right">
        	<button style="float:right;" type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
      </div>
      <div class="modal-body">
        <form action="{{route('g2fa-create')}}" method="POST">
              {{csrf_field()}}
              <div class="form-group">
                <input type="hidden" name="key" value="{{$secret}}">
                <input type="text" class="form-control" name="code" autocomplete="off" placeholder="Enter Google Authenticator Code"> 
              </div>
               <div class="form-group">
...
<div id="disableModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
      	<h6 style="float:left;" class="modal-title">Verify Your OTP to Disable</h6>
        <div class="pull-right">
        	<button style="float:right;" type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
      </div>
      <div class="modal-body">
           <form action="{{route('g2fa-disable')}}" method="POST">
              {{csrf_field()}}
              <div class="form-group">
                <input type="text" class="form-control" name="code" autocomplete="off" placeholder="Enter Google Authenticator Code"> 
              </div>
