...
<!--                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle hidden-xs is-active" href="{{ url('user/wallet')}}"><img style="width: 100px !important;" class="brand-logo" alt="crypto ico admin logo" src="{{ asset('assets/images/logo.png') }}"/></a></li>-->
                              ...
                              <li class="dropdown dropdown-notification nav-item dashboarNav" class="{{ (\Request::route()->getName() == 'wallet') ? 'active' : 'nav-item' }}"><a href="{{ route('wallet') }}"><i class="icon-wallet" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">My Wallet</span></a></li>
                              <li class="dropdown dropdown-notification nav-item dashboarNav" class=""><a href="{{ url('payment/dashboard') }}"><i class="icon-layers" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">Cash In</span></a></li>
                              ...
                              <li class="dropdown dropdown-notification nav-item dashboarNav" class="{{ (\Request::route()->getName() == 'withdraw-request') ? 'active' : 'nav-item' }}"><a href="{!! route('withdraw-request') !!}"><i class="fa fa-money" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">Cash Out</span></a></li>
