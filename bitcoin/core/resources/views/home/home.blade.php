...
<!--                    <input type="submit" class="btn btn-call buyButton formBuy wide" style="background-color: #135577; border-color: #0f4561;    width: 30%;" data-type="btc" value="Buy BTC" id="final_btn">-->
						<a href="{{ route('login') }}" class="btn btn-call buyButton formBuy wide">Buy /Sell BTC</a>
                    <br>
                </form>
                <br><br>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="col-sm-6" style="">
        ...
        <button type="button" class="btn btn-primary"><a href="{{ route('login') }}" >Buy BTC</a></button>
...
<div class="modal fade" id="cfaTobtcModel" tabindex="-1" role="dialog" aria-labelledby="#cfaTobtcModelLabel" aria-hidden="true">
 ...
 <div class="modal-footer">
    ...
    <div class="col-sm-6" style="">
        ...
        <button type="button" class="btn btn-primary"><a href="{{ route('login') }}" >Sell BTC</a></button>
    </div>
  </div>
...
$("#btc").bind("change paste keyup", function() {
    ...
    $("#usdbtc").attr("value", ember.usdCalc*{{$cfavalues->cfa_value}});
});
...
$("#A1").keyup(function() {
    $("#B1").val($("#A1").val()*<?php echo $cfa;?>);
     $("#usdval1").val($("#A1").val()*<?php echo ($btc);?>);
    if($(this).val() < 5000)
...
$("#B1").keyup(function() {
    //$("#A1").val(<?php //echo $cfa;?>/$("#B1").val() );
    $("#A1").val($("#B1").val() / <?php echo $cfa;?>);
     $("#usdval1").val($("#B1").val()*<?php echo (1/$cfavalues->cfa_value);?>);
});
 </script>
...
$("#B2").keyup(function() {
    $("#A2").val($("#B2").val() / <?php echo $cfa2;?>);
    $("#usdval2").val($("#B2").val()*<?php echo (1/$cfavalues->cfa_value);?>);
});
 </script>
