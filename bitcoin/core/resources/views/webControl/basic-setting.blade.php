                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="cashin_commission" value="{{ $basic->cashin_commission }}" type="text" required>
                                            <span class="input-group-addon"><strong>CFA</strong></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="cashout_commission" value="{{ $basic->cashout_commission }}" type="text" required>
                                            <span class="input-group-addon"><strong>CFA</strong></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="exchange_commission" value="{{ $basic->exchange_commission }}" type="text" required>
                                            <span class="input-group-addon"><strong><i class="fa fa-money"></i></strong></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="withdraw_commission" value="{{ $basic->withdraw_commission }}" type="text" required>
                                            <span class="input-group-addon"><strong><i class="fa fa-money"></i></strong></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="btc_buy_commision" value="{{ $basic->btc_buy_commision }}" type="text" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control bold input-lg" name="btc_sell_commision" value="{{ $basic->btc_sell_commision }}" type="text" required>
                                            <span class="input-group-addon"><strong>{{$basic->currency}}</strong></span>
                                        </div>
                                    </div>
                                </div>
