...
background: <?php echo '#1a3c8b';?>;
}

button.submit-btn:hover,
button.submit-btn,
{
background: <?php echo '#00a8df';?>;
}

.about-community{
	background: <?php echo '#FFFFFF !important';?>;
}

.scrolltop, .service-wrapper:hover{
	background: <?php echo '#346da6 !important';?>;
}
