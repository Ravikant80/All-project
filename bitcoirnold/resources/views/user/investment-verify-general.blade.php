...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('identity-verification') }}" id="myForm" role="form" data-toggle="validator" enctype="multipart/form-data" method="post" style="width:100%;">
            {{ csrf_field() }}
            	<div id="smartwizard">
                    <ul>
										...
										<td style="width:50%">
											...
											<tr>
												...
												<div class="form-group">
                                                    ...
                                                    @foreach($identityproofs as $identity)
														<option value="{{ $identity->name }}">{{ $identity->name }}</option>
                                                    @endforeach
													</select>
												</div>
												</td>         
