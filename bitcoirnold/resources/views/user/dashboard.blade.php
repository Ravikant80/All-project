                            ...
                            <div class="card-body">
                                ...
                                <input id="usdbtc" class="form-control nomargin text-right disableButton" data-currency-calc="true" type="text" value="6377.95" placeholder="Enter amount" data-original-title="" title="" onkeyup="update_('btc', this)">
                                    ...
                                    <div class="col-md-4 col-12 mb-1">
                                        <fieldset class="form-label-group mb-0">
                                            <input type="text" class="form-control" id="wallet-address" value="{{ Auth::user()->wallet_address }}" readonly autofocus>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            ...
                                            <h1><i class="fa fa-btc"></i> {{ Auth::user()->bitcoin }} BTC</h1>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <p><strong>Your balance:</strong></p>
                                            <h1>{{ Auth::user()->balance }} CFA</h1>
                                            <!--<p class="mb-0">Welcome bonus <strong>+30%</strong> expires in 21 days.</p>-->
                                        </div>
                                        <div class="col-md-6 col-12 text-center text-md-right">
                                            <!--<a href="{{ asset('user/investment-new') }}"><button type="button" class="btn btn-primary mt-2">Deposit <i class="la la-angle-right"></i></button></a>-->
                                            <a href='{{ url('payment/dashboard') }}'><button type="button" class="btn btn-primary mt-2">Deposit <i class="la la-angle-right"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@if((Auth::user()->phone_verify_status != 1 || Auth::user()->email_verify_status != 1 || Auth::user()->identity_verify_status != 1 || Auth::user()->selfie_verify_status != 1) && Auth::user()->idverify_skip == 1)
