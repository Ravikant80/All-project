...
<div class="container"> 
  <div class="wrapper"> 
    <div class="arrow-steps clearfix">
        <div class="step "> <a href="{{url('user/withdraw-request')}}" style="color: #6d6262 !important;text-decoration: none !important;"><span> Method</span></a> </div>
                    ...
                    <div>
                        <div id="step-2" style="height:400px; width:100%;     background-color: #fff !important;" class="">
                          <div id="form-step-1" role="form" data-toggle="validator">
                                <p>&nbsp;</p>
                                <form action="{{ route('withdraw-submit') }}" class="form-horizontal" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8" style="width:100%; margin-left:30px;">
                                <p>&nbsp;</p>
                                {{ csrf_field() }}
                                <input type="hidden" name="usd_wallet" id="usd_wallet" value="{{ Auth::user()->balance }}">
                                <input type="hidden" name="btc_wallet" id="btc_wallet" value="{{ Auth::user()->bitcoin }}">
                                <input type="hidden" id="withdraw_commission1" name="withdraw_commission1" value="{{ $basic->withdraw_commission }}" />
                                
                                <div class="form-group row">
                                   <label class="col-md-4">Withdraw Mobile Number</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control text-right" name="phone" id="withdraw_phone" autocomplete="off" placeholder="0" value="{{ Auth::user()->phone }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input readonly="" type="text" class="form-control text-right" name="withdraw_commission" id="withdraw_commission" autocomplete="off" value="{{ $basic->withdraw_commission }}">
                                ...
                                <div class="form-group row">
                                 ...
                                 <a href="{{url('withdraw/request')}}" class="btn btn-primery" style="border: 1px solid;">
                             Back</a>
                                 </div>
                                    <div class="col-md-6">
                                        <span onclick="sendRequest('{{ url('payment/withdraw') }}','depositForm',this)" class="btn btn-primary btn-block">Withdraw</span>
                                    </div>
                                </div>                               
                            </form>
                          </div>
