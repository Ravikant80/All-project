 ...
 <section style="background-image: url('{{ asset('assets/images') }}/{{ $basic->breadcrumb }}')" class="breadcrumb-section contact-bg section-padding">
    ...
    width: 300px;"></a>
                                    ...
                                    <div class="item-content">
                                       <h2><a href="{{url('news/'.str_slug($newsData->headlines).'/'.$newsData->news_id)}}">{{$newsData->headlines}}</a></h2>
                                       <?php
                                       ...
                                       <span class="item-meta-item"><i class="fa fa-clock-o"> post_time</i> {{ $updt }}</span>
<!--                                       <a href="post.html#comments" class="item-meta-item"><i class="fa fa-clock-o">chat_bubble_outline</i>35</a>-->
                                       </span>
                                       <p> <?php echo substr($newsData->story,0,200) ?> ..</p>
                                       <a href="{{url('news/'.str_slug($newsData->headlines).'/'.$newsData->news_id)}}" class="img-read-later-button">Read More ..</a>
                                    </div>
                                 </div>
