        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item">
                 ...
                 <!--<li class="nav-item">
                    <a href="{!! route('user-deposit-history')  !!}" class="nav-link nav-toggle"><i class="fa fa-credit-card"></i>
                ...
                <li class="nav-item">
                    <a href="{!! route('manage-proofs') !!}" class="nav-link nav-toggle"><i class="fa fa-id-card"></i>
                        <span class="title">Identity Proofs</span></a>
                </li>
                
                <!--<li class="nav-item">-->
                <!--    <a href="{!! route('manage-exchange') !!}" class="nav-link nav-toggle"><i class="fa fa-exchange"></i>-->
                <!--        <span class="title">Exchange Request</span></a>-->
                <!--</li>-->
                <!--<li class="nav-item">-->
                <!--    <a href="{!! route('manage-cashout') !!}" class="nav-link nav-toggle"><i class="fa fa-calculator"></i>-->
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('identity-proofs') !!}" class="nav-link nav-toggle"><i class="fa fa-list"></i>
                                <span class="title">All Proofs</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('government-proofs') !!}" class="nav-link nav-toggle"><i class="fa fa-edit"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{!! route('industries') !!}" class="nav-link nav-toggle"><i class="fa fa-list"></i>
                                <span class="title">All Industries</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('industry-add') !!}" class="nav-link nav-toggle"><i class="fa fa-edit"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                       ...
                       <!-- <li class="nav-item">
                            <a href="{!! route('blockchain-setting') !!}" class="nav-link nav-toggle"><i class="fa fa-wrench"></i>
                                <span class="title">Blockchain Setting</span></a>
                        </li>-->
                        <li class="nav-item">
                            <a href="{!! route('contact-setting') !!}" class="nav-link nav-toggle"><i class="fa fa-phone-square"></i>
                                <span class="title">Contact Setting</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('email-setting') !!}" class="nav-link"><i class="fa fa-envelope"></i>
                                Email Setting </a>
                        </li>
                        <li class="nav-item">
                            <a href="{!! route('sms-setting') !!}" class="nav-link"><i class="fa fa-commenting"></i>
                                SMS Setting </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a href="{!! route('news-section') !!}" class="nav-link nav-toggle"><i class="fa fa-newspaper-o"></i>
                        <span class="title">News Section</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{url('admin/setcfa-values')}}" class="nav-link nav-toggle"><i class="fa fa-newspaper-o"></i>
                 ...
                 <li class="nav-item">
                      <a href="javascript:;" class="nav-link nav-toggle"><i class="fa fa-arrows"></i>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{url('admin/bitcoin-buy-request')}}" class="nav-link"><i class="fa fa-minus"></i>
                                        Buy Request</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('admin/bitcoin-sell-request')}}" class="nav-link"><i class="fa fa-plus"></i>
                                        Sell Request</a>
                                </li>
                            </ul>
                 </li>
                 <!--
                 <li class="nav-item">
                    <a href="{{url('admin/commission-chart')}}" class="nav-link nav-toggle"><i class="fa fa-newspaper-o"></i>
    ...
    <div class="page-content-wrapper" >
        <div class="page-content">
           <div class="col-md-12" style="display: flex;">
            ...
            <div class="col-md-8"><p align="center" style="margin: 7px 0!important;"><span>BTC Balance :</span><span>{{round($admindata->balance,8)}}</span>
                <span> CFA Balance :</span><span>{{round($admindata->bitcoin,8)}}</span></p>
            </div>
            </div>
