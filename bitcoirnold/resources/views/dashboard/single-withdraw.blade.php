                        ...
                        <div class="col-md-12">
                            <div class="text-center bold">
                            	<table class="table table-bordered">
                                	<tr>
                                    	<th>Request User</th>
                                        <td style="text-align:justify;"><h5>{{ $deposit->user->name }}</h5></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                    	...
                                    	<td style="text-align:justify;"><h5>{{ $deposit->from_wallet }}</h5></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                    	<th>User Receive Amount</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->net_amount }}</h5></td>
                                    </tr>                                  
                                    <tr>
