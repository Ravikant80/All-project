                        ...
                        <div class="col-md-12">
                            <div class="text-center bold">
                            	<table class="table table-bordered">
                                	<tr>
                                    	<th>Request User</th>
                                        <td style="text-align:justify;"><h5>{{ $deposit->member->name }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Transaction Id</th>
                                    	<td style="text-align:justify;"><h5>#{{ $deposit->transaction_id }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Cash-in Amount</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->amount }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Payment Gateway</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->bank->name }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Payment Gateway Fee</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->rate }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Ct-Pay Commission</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->charge }}</h5></td>
                                    </tr>
                                    <tr>
                                    	<th>Status</th>
                                ...
                                <div class="col-md-3 col-md-offset-3">
                                    <button type="button" class="btn green-haze bold uppercase btn-block delete_button"
                                            ...
                                            data-id="{{ $deposit->id }}">
                                        <i class='fa fa-check'></i> Approve Cash-in
                                    </button>
                                </div>
                                <div class="col-md-3">
                                    <button type="button" class="btn purple bold uppercase btn-block refund_button"
                                            ...
                                            data-id="{{ $deposit->id }}">
                                        <i class='fa fa-times'></i> Reject Cash-in
                                    </button>
                                </div>
                                @endif
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="{{ route('cashin-confirm') }}" class="form-inline">
                        {!! csrf_field() !!}
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('cashin-reject') }}" class="form-inline">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" class="abir_id" value="0">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Yes I'm Sure..!</button>
