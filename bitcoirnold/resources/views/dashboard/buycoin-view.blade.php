                        ...
                        <div class="col-md-12">
                            <div class="text-center bold">
                            	<table class="table table-bordered">
                                	<tr>
                                    	<th>Request User</th>
                                        <td style="text-align:justify;"><h5>{{ $deposit->btcmembers->name }}</h5></td>
                                    </tr>
                                   
                                    <tr>
                                        <th>CFA Amount</th>
                                        <td style="text-align:justify;"><h5>{{ $deposit->cfa_amount }}</h5></td>
                                    </tr>

                                    <tr>
                                    	<th>User Get Btc  Amount</th>
                                    	<td style="text-align:justify;"><h5>{{ $deposit->btc_amount }}</h5></td>
                                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="{{ url('admin/buycoin-confirm/'.$deposit->btcreqid) }}" class="form-inline">
                        {!! csrf_field() !!}
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ url('admin/buycoin-reject/'.$deposit->btcreqid) }}" class="form-inline">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" class="abir_id" value="0">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Yes I'm Sure..!</button>
