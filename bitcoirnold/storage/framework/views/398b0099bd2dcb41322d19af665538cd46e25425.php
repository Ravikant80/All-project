...
<div class="row" style="width:100%;" align="center">
                  ...
                  <div id="step-1" style="height:400px; width:100%; background-color: none !important;" class="">
                    ...
                    <div class="">
                      <div class="ca-page-title ca-center-align">
                            <h3 style="text-align: center;padding-top: 30px; padding-bottom: 20px;">How would you like to Cash-Out?</h3>
                          </div>
   ...
   <div class="col-md-12" style="display:  inline-flex;">
       ...
       <div class="col-md-4">
        <a href="<?php echo e(url('user/withdraw-payment')); ?>" style="text-decoration: none;">
       ...
       <div class="col-md-4" title="Comming Soon!">
         ...
         <div class="form-group">
                          ...
                          <div id="ember1570" class="ember-view featured-outlets__outlet"><div class="featured-outlets__content ">
                              ...
                              <div>
                                <img class="featured-outlets__logo" src="<?php echo e(asset('assets/img/paypal-logo.png')); ?>">
                              </div>
       ...
       <div class="col-md-4" title="Comming Soon!">
           ...
           <div class="form-group">
                          ...
                          <div id="ember1570" class="ember-view featured-outlets__outlet"><div class="featured-outlets__content ">
                              ...
                              <div>
                                <img class="featured-outlets__logo" src="<?php echo e(asset('assets/img/paytm1.jpg')); ?>" >
                              </div>
