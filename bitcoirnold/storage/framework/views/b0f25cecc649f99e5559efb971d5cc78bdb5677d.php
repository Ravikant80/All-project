         ...
         <div class="box-outline col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 exchange">
            ...
            <div class="exchange__input-group-flex"></div>
              <div class="exchange__amount-preview" data-ember-action="1415">
                <input type="text" class="form-control exchange__amount-input" name="from_amount" id="cfa_amount" autocomplete="off" value="<?php echo e(Auth::user()->balance); ?>" placeholder="Enter CFA Amount">

                <input type="text" class="form-control exchange__amount-input" name="from_amount" id="cfa_amount2" autocomplete="off" value="<?php echo e(Auth::user()->bitcoin); ?>" placeholder="Enter CFA Amount">
              </div>
          ...
          <div class="exchange__wallet-balance cfaBalance">Wallet balance:
            <?php echo e(Auth::user()->balance); ?> CFA
          </div>
          <div class="exchange__wallet-balance btcBalance">Wallet balance:
            <?php echo e(Auth::user()->bitcoin); ?> BTC
          </div>
        <!---->
        </div>
               ...
               <div class="exchange__separator">
                  <button class="exchange__separator-button" title="Swap currencies" data-ember-action="1849" onclick="SwapDivsWithClick()">
                     <svg class="exchange__separator-icon">
                        <use xlink:href="#icon-exchange-convert"><img src="<?php echo e(asset('assets/images/repeat.png')); ?>" class="swipe-image"></use>
                     </svg>
                  </button>
             ...
             <!-- ===================== End Conversion Section ==================== -->
               ...
               <button class="button--new button-block button-primary buyDisp" >
                  <a href="<?php echo e(url('user/buy-bitcoin')); ?>" class="btn btn-primary btn-block">Convert</a>
               </button>
               <button class="button--new button-block button-primary sellDisp" >
               <a href="<?php echo e(url('user/sell-coin')); ?>" class="btn btn-primary btn-block">Convert</a>
               </button>
