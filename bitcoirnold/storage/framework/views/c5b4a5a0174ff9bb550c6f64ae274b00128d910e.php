                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <h3 class="text-center " id="changebalance"><?php echo e(round(Auth::user()->balance,8)); ?> </h3>
                            <h1 class="text-center" id="currency-value-cfa"><?php echo e($basic->symbol); ?></h1>
                        </div>
...
<!--                                     <td id="showReceiveSect"><a href="javascript:;" class="text-center btn btn-default" style="font-size: 12px !important;" data-toggle="modal" data-target="#sellCoinModal"><i class="fa fa-money"></i> Sell</a></td>-->
                                 ...
                                 <td id="showcfaCashIn"><a href="<?php echo e(url('payment/dashboard')); ?>" class="text-center btn btn-default" style="font-size: 12px !important; color: #000;" ><i class="fa fa-money"></i> Cash In </a></td>
                                 ...
                                 <td id="showBuySect"><a href="<?php echo e(url('user/buy-bitcoin')); ?>" class="text-center btn btn-default" style="font-size: 12px !important; color: #000;"><i class="fa fa-shopping-cart"></i> Buy Btc</a></td>
                        ...
                        <div class="table-responsive">
                              <table class="table table-de mb-0">                    
                                <tbody>
                                  ...
                                  <tr>
                                    <td id="cfaidcfa" style="cursor: pointer;"><?php echo e($basic->symbol); ?></td>
                                    <td> <?php echo e(round(Auth::user()->balance,8)); ?> <?php echo e($basic->symbol); ?></td>                        
                                  </tr> 
                                  <tr>
<!--                                          <td align="center" colspan="2" ><a href="javascript:;" style="color:#000000;" data-toggle="modal" data-target="#CurConversionModal"><i class="fa fa-exchange"></i> Convert</a></td>-->
                                       <td align="center" colspan="2" ><a href="<?php echo e(url('user/exchange')); ?>" style="color:#000000;" ><i class="fa fa-exchange"></i> Convert</a></td>
                                  </tr>                     
                                </tbody>
                              </table>
                        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                    <a href="<?php echo e(url('/user/reference-user')); ?>"  style="color: #000;" class="btn btn-default btn-block"><i class="fa fa-gift"></i> Referal users : <?php echo e($refer); ?></a>
                    </div>
                </div>
                ...
                <div class="card">
                        <div class="card-content collapse show" style="padding: 7px;text-align: center;">
                                ...
                                <td class="text-center btn btn-default" style="color: #000;"><i class="fa fa-money"></i> Bonus Amount : <?php echo e(round($amountsum,8)); ?> <?php echo e($basic->symbol); ?> </td>
                  ...
                  <i class="text-danger" id="amount_less_error"></i>
                    ...
                    <div class="form-group">
                        <label for="cashout">BTC Value</label>
                               <input type="hidden" class="form-control text-right" autocomplete="off" name="cash_out_commision" id="cash_out_commision" placeholder="0"  value="<?php echo e($basic->btc_buy_commision * $cfavalue); ?>" readonly>
                ...
                <p style="text-align: center;;"> Share this address to receive money form your friends. Or use it to transfer money from another BTC service.</p>
                    ...
                    <div class="col-md-12" style="display: -webkit-inline-box;">
                        <div class="col-sm-11 col-lg-11 col-sm-11">
                            <div class="row">
                                <input  type="text" class="form-control text-right" autocomplete="off" name="uwallet_address" id="uwallet_address" required readonly="" value="<?php echo e(Auth::user()->wallet_address); ?>" style="box-shadow: none!important;">
                            </div>
                        </div>
                        <div class="col-md-1 col-lg-1 col-sm-1">
                            <div class="row">
                     ...
                     <div class="" style="text-align: center; margin-top: 40px;" >
                        <img src="<?php echo e(asset('assets/img/b-code.png')); ?>">
                     </div>
             </div>          
      </div>
 <div class="modal-footer">
...
<?php if(( Auth::user()->identity_verify_status != 1) && Auth::user()->idverify_skip == 1): ?>
