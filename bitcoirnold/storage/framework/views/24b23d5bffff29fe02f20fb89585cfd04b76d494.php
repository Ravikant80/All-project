...
<div class="modal-content" style="border-radius: 1rem;">
  ...
  <div class="modal-footer">
    <a href="<?php echo e(url('user/exchange')); ?>"  type="" class="btn btn-secondary" data-dismiss="modal">Back</a>
    ...
    $("#cfa_amounts").keyup(function(){
       ...
       $("#btc_amounts").val($("#cfa_amounts").val()/<?php echo $cfa;?>);
        ...
        if($(this).val() > <?=Auth::user()->balance;?> || $(this).val()  == 0)
        {
            ...
            $("#amount_less_error").text("Please enter an amount within your current wallet balance of <?=Auth::user()->balance;?>  <?php echo e($basic->symbol); ?>");
            $('#buyBtcConfModelId').hide();
        }
        else
        {   
