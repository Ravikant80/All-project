        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(url('admin/identity-confirm/'.$idproof->id)); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(url('admin/identity-reject/'.$idproof->id)); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
