            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="logo" style="padding: 15px;">
                        <a href=""><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" width="" title="CT-PAY Logo" style="width: 7em;"></a>
                    </div>
                </div>
                 <div class="col-md-4">
                <div id="price-quoter" class="price-quoter" style="    margin-top: 21px;
    color: white;"><span>Buy: <?php echo e(btcBuyValue()); ?> CFA &nbsp;&nbsp; | &nbsp;&nbsp; Sell: <?php echo e(btcSellValue()); ?> CFA</span></div>
              </div>
...
<!--              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="<?php echo e(route('wallet')); ?>"><i class="ficon icon-wallet"></i></a></li>-->
              ...
              <li class="dropdown dropdown-user nav-item">
                ...
                <?php endif; ?>
                </span><span class="mr-1 username-1"><?php echo e(Auth::user()->name); ?></span></a>
...
<!--                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle hidden-xs is-active" href="<?php echo e(url('user/wallet')); ?>"><img style="width: 100px !important;" class="brand-logo" alt="crypto ico admin logo" src="<?php echo e(asset('assets/images/logo.png')); ?>"/></a></li>-->
                              ...
                              <li class="dropdown dropdown-notification nav-item dashboarNav" ><a href="<?php echo e(route('wallet')); ?>" class="<?php echo e((\Request::route()->getName() == 'wallet') ? 'active' : 'nav-item'); ?>"><i class="icon-wallet" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">My Wallet</span></a></li>
                              <li class="dropdown dropdown-notification nav-item dashboarNav" class=""><a href="<?php echo e(url('payment/dashboard')); ?>" class="<?php echo e(Request::is( 'payment/dashboard') ? 'active' : ''); ?>"><i class="icon-layers" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">Cash In</span></a></li>
                              
                              <li class="dropdown dropdown-notification nav-item dashboarNav" ><a href="<?php echo route('withdraw-request'); ?>" class="<?php echo e((\Request::route()->getName() == 'withdraw-request') ? 'active' : 'nav-item'); ?>"><i class="fa fa-money" style="font-size: 1.5rem;"></i><span class="menu-title" data-i18n="">Cash Out</span></a></li>
