            ...
            <div class="col-md-8 col-md-offset-2 text-center" id="hpsilderbtc" style="margin-top: 5%;">
                <form action="/place_order?" method="get" id="form_btc">
                    ...
                    <br>
                        ...
                        <a href="<?php echo e(url('user/buy-bitcoin')); ?>" class="btn btn-call buyButton formBuy wide">Buy /Sell BTC</a>
                    <br>
                </form>
                <br><br>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="col-sm-6" style="">
        ...
        <button type="button" class="btn btn-primary"><a href="<?php echo e(url('user/buy-bitcoin')); ?>" >Buy BTC</a></button>
...
<div class="modal fade" id="cfaTobtcModel" tabindex="-1" role="dialog" aria-labelledby="#cfaTobtcModelLabel" aria-hidden="true">
 ...
 <div class="modal-footer">
    ...
    <div class="col-sm-6" style="">
        ...
        <button type="button" class="btn btn-primary"><a href="<?php echo e(url('user/sell-coin')); ?>" >Sell BTC</a></button>
    </div>
  </div>
