                        ...
                        <div class="col-md-12">
                            <div class="text-center bold">
                            	<table class="table table-bordered">
                                	<tr>
                                    	<th>Request User</th>
                                        <td style="text-align:justify;"><h5><?php echo e($deposit->btcmembers->name); ?></h5></td>
                                    </tr>
                                ...
                                <div class="col-md-3 col-md-offset-3">
                                    <button type="button" class="btn green-haze bold uppercase btn-block delete_button"
                                            ...
                                            data-id="<?php echo e($deposit->btcreqid); ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="<?php echo e(url('admin/buycoin-confirm/'.$deposit->btcreqid)); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(url('admin/buycoin-reject/'.$deposit->btcreqid)); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
