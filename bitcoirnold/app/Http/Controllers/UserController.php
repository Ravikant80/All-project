...
$ul['description'] = $request->cfa_amounts." ".$basic->currency." transfer for Buy ".$basic->bitcoin_currency;
$ul['transaction_id'] = $tr;
UserLog::create($ul);
...
$ul['description'] = $request->btc_amount." ".$basic->bitcoin_currency." transfer for Sell ".$basic->currency;
