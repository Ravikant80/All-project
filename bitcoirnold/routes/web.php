...
//    Route::post('bitcoin-manual-method',['as'=>'bitcoin-manual-method','uses'=>'DashboardController@editBitcoinManualDeposit']);
	...
	Route::post('identity-confirm/{id}',['as'=>'identity-confirm','uses'=>'DashboardController@confirmIDverification']);
    Route::post('identity-reject/{id}',['as'=>'identity-reject','uses'=>'DashboardController@rejectIDverification']);
