...
<head>
    ...
    <link href="{{asset('ecommerce/assets/admin/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('ecommerce/assets/admin/css/simple-line-icons.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('ecommerce/assets/admin/css/components-rounded.min.css')}}" rel="stylesheet" id="style_components" type="text/css" />
    <link href="{{asset('ecommerce/assets/admin/css/plugins.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('ecommerce/assets/admin/css/login.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- END STYLES -->
...
<!-- BEGIN LOGO -->
<div class="logo">
    <a href="#"><img src="{{asset('ecommerce/assets/images/logo.png')}}" alt="-" style="max-width: 150px"/> </a>
</div>
<!-- END LOGO -->
...
<script src="{{asset('ecommerce/assets/admin/js/js.cookie.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('ecommerce/assets/admin/js/jquery.validate.min.js')}}" type="text/javascript"></script>
<script src="{{asset('ecommerce/assets/admin/js/additional-methods.min.js')}}" type="text/javascript"></script>
<script src="{{asset('ecommerce/assets/admin/js/app.min.js')}}" type="text/javascript"></script>
<script src="{{asset('ecommerce/assets/admin/js/login.min.js')}}" type="text/javascript"></script>
<!-- END SCRIPTS -->
